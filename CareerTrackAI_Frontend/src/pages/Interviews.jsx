...
import useInterviewsController from './interviews/useInterviewsController.js'
...
function Interviews() {
  ...
  return (
    <div className="space-y-6">
      ...
      {message && (
        <DismissibleNotice
          className="border-teal-200 bg-teal-50 text-sm font-semibold text-teal-800 dark:border-teal-800 dark:bg-teal-950/50 dark:text-teal-100"
